        ...
        <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
            <div class="mr-auto place-self-center lg:col-span-7">
                ...
                <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    <a href="/register" class="inline-flex items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-[#f21a3f] border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-4 focus:ring-[#f21a3f] dark:text-[#f21a3f] dark:border-[#f21a3f] dark:hover:bg-[#fdd3da] dark:focus:ring-[#fdd3da]">
                     Get Started
                    </a> 
                </div>
            </div>
