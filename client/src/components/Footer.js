        ...
        <div class="md:flex md:justify-between">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul class="text-gray-600 dark:text-white font-medium">
                      <li class="mb-4">
                          <a href="#" class="hover:underline dark:hover:text-[#c60b2b]">Privacy Policy</a>
                      </li>
                      <li>
                          <a href="#" class="hover:underline dark:hover:text-[#c60b2b]">Terms &amp; Conditions</a>
                      </li>
                  </ul>
              </div>
          </div>
      </div>
      <hr class="my-2 border-[#f21a3f]  sm:mx-auto dark:border-white lg:my-2" />
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-white">© 2023 <a class="hover:underline">NSCC</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a href="#" class="text-white hover:text-gray-900 dark:hover:text-[#c60b2b]">
