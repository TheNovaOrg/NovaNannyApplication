...
function Parent() {
    return (
        ...
        <div class='flex items-center justify-center min-h-screen from-white via-white to-white bg-gradient-to-br'>
                ...
                <div class="pb-6">
                    <div class="flex flex-wrap justify-center">
                        <div class="flex justify-center w-full">
                            <div class="relative">
                                <img src="img/dad2.jpg" class="dark:shadow-xl border-[#F43F5E] dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]" />
                            </div>
                        </div>
                    </div>
                    <div class="mt-2 mt-20 text-center">
                        <h3 class="mb-1 text-2xl font-bold leading-normal text-black dark:text-black">Joel Clayton</h3>
                        <div class="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-[#F43F5E] " viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clip-rule="evenodd"></path>
                            </svg>

                            <div class="text-sm font-bold tracking-wide text-black dark:text-black font-'Montserrat Alternates', sans-serif; text-xl">Halifax, Nova Scotia</div>
                            {/* <a href="#" class="text-white  hover:text-[#c60b2b] dark:hover:text-[#c60b2b]"> */}
                        </div>
                        <div class="w-full text-center">
                            <div class="flex justify-center pt-8 pb-0 lg:pt-4">
                                <div class="flex space-x-2">
                                    <a
                                        class="p-1 -m-1 text-[#F43F5E]  hover:text-[#fdd3da] focus-visible:ring-2 ring-primary"
                    ...
                    <div class="pt-6 mx-6 mt-6 text-center border-t border-[#c60b2b] dark:border-[#c60b2b]">
                        <div class="flex flex-wrap justify-center">
                            <div class="w-full px-6 border-[#c60b2b]">
                                <p class="mb-4 font-light leading-relaxed text-black dark:text-black">
                    ...
                    <div class="relative h-6 overflow-hidden translate-y-6 rounded-b-xl">
                        <div class="absolute flex-space-x-12 rounded-b-2xl bg-magic potion">
                            <div class="w-36 h-8 transition-colors duration-200 delay-75 transform skew-x-[35deg] bg-magic potion-400/90 group-hover:bg-magic potion-600/90 z-10"></div>
                            <div class="w-28 h-8 transition-colors duration-200 delay-100 transform skew-x-[35deg] bg-magic potion-300/90 group-hover:bg-magic potion-500/90 z-20"></div>
                            <div class="w-28 h-8 transition-colors duration-200 delay-150 transform skew-x-[35deg] bg-magic potion-200/90 group-hover:bg-magic potion-400/90 z-30"></div>
                            <div class="w-28 h-8 transition-colors duration-200 delay-200 transform skew-x-[35deg] bg-magic potion-100/90 group-hover:bg-magic potion-300/90 z-40"></div>
                            <div class="w-28 h-8 transition-colors duration-200 delay-300 transform skew-x-[35deg] bg-magic potion-50/90 group-hover:bg-magic potion-200/90 z-50"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        /* <div class="flex flex-col mx-auto my-24 justify-center w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="flex justify-end px-4 py-8 h-120">
            ...
            <div class="flex flex-col items-center pb-10">
                <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="img/dad2.jpg" alt="Bonnie image"/>
                <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Tom Green</h5>
                <span class="text-sm text-gray-500 dark:text-gray-400">Parent of Triplets</span>
