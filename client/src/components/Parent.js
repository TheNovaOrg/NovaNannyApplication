                ...
                <div class="pb-6">
                    ...
                    <div class="relative h-6 overflow-hidden translate-y-6 rounded-b-xl">
                        <div class="absolute flex-space-x-12 rounded-b-2xl bg-magic potion">
                            <div class="w-36 h-8 transition-colors duration-200 delay-75 transform skew-x-[35deg] bg-magicpotion-400/90 group-hover:bg-magicpotion-600/90 z-10"></div>
                            <div class="w-28 h-8 transition-colors duration-200 delay-100 transform skew-x-[35deg] bg-magicpotion-300/90 group-hover:bg-magicpotion-500/90 z-20"></div>
                            <div class="w-28 h-8 transition-colors duration-200 delay-150 transform skew-x-[35deg] bg-magicpotion-200/90 group-hover:bg-magicpotion-400/90 z-30"></div>
                            <div class="w-28 h-8 transition-colors duration-200 delay-200 transform skew-x-[35deg] bg-magicpotion-100/90 group-hover:bg-magicpotion-300/90 z-40"></div>
                            <div class="w-28 h-8 transition-colors duration-200 delay-300 transform skew-x-[35deg] bg-magicpotion-50/90 group-hover:bg-magicpotion-200/90 z-50"></div>
                        </div>
                    </div>
                </div>
            </div>
