...
function Parent() {
    return (
        ...
        <div className='flex items-center justify-center min-h-screen from-white via-white to-white bg-gradient-to-br'>
            <div className="relative w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-words bg-white border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl">
                <div className="pb-6">
                    <div className="flex flex-wrap justify-center">
                        <div className="flex justify-center w-full">
                            <div className="relative">
                                <img src="img/dad2.jpg" className="dark:shadow-xl border-[#F43F5E] dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]" />
                            </div>
                        </div>
                    </div>
                    <div className="mt-2 mt-20 text-center">
                        <h3 className="mb-1 text-2xl font-bold leading-normal text-black dark:text-black">Joel Clayton</h3>
                        <div className="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-[#F43F5E] " viewBox="0 0 20 20" fill="currentColor">
                                <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd"></path>
                            </svg>

                            <div className="text-sm font-bold tracking-wide text-black dark:text-black font-'Montserrat Alternates', sans-serif; text-xl">Halifax, Nova Scotia</div>
                            {/* <a href="#" className="text-white  hover:text-[#c60b2b] dark:hover:text-[#c60b2b]"> */}
                        </div>
                        <div className="w-full text-center">
                            <div className="flex justify-center pt-8 pb-0 lg:pt-4">
                                <div className="flex space-x-2">
                                    <a
                                        className="p-1 -m-1 text-[#F43F5E]  hover:text-[#fdd3da] focus-visible:ring-2 ring-primary"
                    ...
                    <div className="pt-6 mx-6 mt-6 text-center border-t border-[#c60b2b] dark:border-[#c60b2b]">
                        <div className="flex flex-wrap justify-center">
                            <div className="w-full px-6 border-[#c60b2b]">
                                <p className="mb-4 font-light leading-relaxed text-black dark:text-black">
                                    Hello Nova Nanny's! I'm searching for a nanny to care for my school-aged son after-school and during school breaks. Ideally I would love someone who can provide homework assistance along with enriching activities and outings. Looking forward to connecting!
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="relative h-6 overflow-hidden translate-y-6 rounded-b-xl">
                        <div className="absolute flex-space-x-12 rounded-b-2xl bg-magic potion">
                            <div className="w-36 h-8 transition-colors duration-200 delay-75 transform skew-x-[35deg] bg-magic potion-400/90 group-hover:bg-magic potion-600/90 z-10"></div>
                            <div className="w-28 h-8 transition-colors duration-200 delay-100 transform skew-x-[35deg] bg-magic potion-300/90 group-hover:bg-magic potion-500/90 z-20"></div>
                            <div className="w-28 h-8 transition-colors duration-200 delay-150 transform skew-x-[35deg] bg-magic potion-200/90 group-hover:bg-magic potion-400/90 z-30"></div>
                            <div className="w-28 h-8 transition-colors duration-200 delay-200 transform skew-x-[35deg] bg-magic potion-100/90 group-hover:bg-magic potion-300/90 z-40"></div>
                            <div className="w-28 h-8 transition-colors duration-200 delay-300 transform skew-x-[35deg] bg-magic potion-50/90 group-hover:bg-magic potion-200/90 z-50"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        /* <div className="flex flex-col mx-auto my-24 justify-center w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div className="flex justify-end px-4 py-8 h-120">
            ...
            <div className="flex flex-col items-center pb-10">
                <img className="w-24 h-24 mb-3 rounded-full shadow-lg" src="img/dad2.jpg" alt="Bonnie image"/>
                <h5 className="mb-1 text-xl font-medium text-gray-900 dark:text-white">Tom Green</h5>
                <span className="text-sm text-gray-500 dark:text-gray-400">Parent of Triplets</span>
